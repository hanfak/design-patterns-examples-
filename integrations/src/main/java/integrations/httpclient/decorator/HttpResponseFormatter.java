...
public class HttpResponseFormatter  {
    ...
    public String formatResponse(Response httpResponse) {
        int statusCode = httpResponse.getStatus();
        String responseBody = Optional.ofNullable(httpResponse.getEntity()).map(Object::toString).orElse("");
        String headers = convertHeadersToDisplayFormat(httpResponse.getStringHeaders().entrySet());
