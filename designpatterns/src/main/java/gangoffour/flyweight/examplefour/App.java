...
public class App {
  ...
  // and getRandWeapon()
  private static final List<String> playerType = Arrays.asList("Terrorist", "CounterTerrorist");
  private static final List<String> weapons = Arrays.asList("AK-47", "Maverick", "Gut Knife", "Desert Eagle");
