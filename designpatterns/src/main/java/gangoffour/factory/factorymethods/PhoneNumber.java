...
public class PhoneNumber {
  ...
  // Use static designpatterns.gangoffour.factory methods
  // Only this class can create an instance of this object
  // Can have several designpatterns.gangoffour.factory methods and give appropriate names the
  ...
  public static void main(String... args) {
    ...
    System.out.println(common.equals(common2)); // flyway pattern allows to use ==
  }
}
