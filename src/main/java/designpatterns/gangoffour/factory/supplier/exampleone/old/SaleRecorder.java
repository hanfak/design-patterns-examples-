package designpatterns.gangoffour.factory.supplier.exampleone.old;

import designpatterns.gangoffour.factory.supplier.exampleone.AcmeSalesServer;
...
public class SaleRecorder {
    ...
    /**
     ...
     method is called. Plus AcmeBillingServer.connect() is a static designpatterns.gangoffour.factory method, which news up an instance of
     AcmeBillingServer.
