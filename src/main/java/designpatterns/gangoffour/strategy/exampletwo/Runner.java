...
public class Runner {
  public static void main(String[] args) {
    ...
    System.out.println("Common immpl of designpatterns.gangoffour.strategy\n");
    ...
    System.out.println("Java 8 functional way of implemnenting designpatterns.gangoffour.strategy\n");
