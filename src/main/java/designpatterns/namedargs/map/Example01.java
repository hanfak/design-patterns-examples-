...
import static designpatterns.namedargs.map.Force.*;
import static designpatterns.namedargs.map.PunchArgs.*;
import static designpatterns.namedargs.map.Speed.*;
...
public class Example01 {
  ...
  public static void main(String[] args) {
    ...
    int punchAmount3 = robot.punch2(punchArgs().force(1).speed(100));
    System.out.println("punchAmount3 = " + punchAmount3);

    // build with defaulted value for force
    int punchAmount3a = robot.punch2(punchArgs().speed(100));
