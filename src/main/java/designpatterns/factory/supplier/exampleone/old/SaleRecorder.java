...
import designpatterns.factory.supplier.exampleone.AcmeSalesServer;
...
public class SaleRecorder {
    ...
    /**
     ...
     method is called. Plus AcmeBillingServer.connect() is a static designpatterns.factory method, which news up an instance of
     AcmeBillingServer.
