package concurrency.concurrency.starvation.after; /**
...
public class StarvationDemo {
    public static void main(String[] args) {
        ...
        // The increase in threads, leads to some threads not running
        for (int i=0; i<5000; i++) {// increase number of philosohers
            // fix the order, on the locks, as before olivia was the only one going for b
            // while baron and steve were competing for a
