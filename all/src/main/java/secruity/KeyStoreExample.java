...
public class KeyStoreExample {
  ...
  public static X509Certificate generateRootCert(KeyPair pair) throws IOException, OperatorCreationException, CertificateException, org.bouncycastle.operator.OperatorCreationException {
